/* FOG CASHIER Ver.49 schedule entry + client registration + cast ordering */
(()=>{
  if(window.__fogScheduleV49Loaded)return;
  window.__fogScheduleV49Loaded=true;
  ...
  if(typeof renderSchedule==='function'&&!window.__fogV49RenderScheduleWrapped){
    ...
    window.__fogV49RenderScheduleWrapped=true;
  }

  if(typeof saveReservation==='function'&&!window.__fogV49SaveReservationWrapped){
    ...
    window.__fogV49SaveReservationWrapped=true;
  }

  if(typeof saveClient==='function'&&!window.__fogV49SaveClientWrapped){
    ...
    window.__fogV49SaveClientWrapped=true;
  }
  ...
  function decorateMasterSortButton(){
    ...
    if(!actions||actions.querySelector('#fogCastSortOpen'))return;
    const btn=document.createElement('button');
    btn.type='button';
  ...
  if(typeof openMaster==='function'&&!window.__fogV49OpenMasterWrapped){
    ...
    window.__fogV49OpenMasterWrapped=true;
  }
