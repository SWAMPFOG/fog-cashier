...
function loadFogUxV51(){
  if(window.__fogUxV51Loader)return;
  const uxScript=document.createElement("script");
  uxScript.src="./cashier-ux-v51.js?v=51";
  uxScript.defer=false;
  document.body.appendChild(uxScript);
  window.__fogUxV51Loader=true;
}

function loadFogScheduleV50(){
  if(window.__fogScheduleV50Loader){
    loadFogUxV51();
    return;
  }
  const scheduleScript=document.createElement("script");
  scheduleScript.src="./cashier-schedule-v50.js?v=51";
  scheduleScript.defer=false;
  scheduleScript.onload=loadFogUxV51;
  scheduleScript.onerror=loadFogUxV51;
...
function loadFogOpsV48(){
  ...
  opsScript.src="./cashier-ops-v48.js?v=51";
...
if(!window.__fogV47EnhancementLoader){
  ...
  enhancementScript.src="./cashier-enhancements-v47.js?v=51";
...
if(fogVersionBadge)fogVersionBadge.textContent="Ver.51";
